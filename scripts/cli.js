...
const contractABI = require("../artifacts/contracts/Walletsynth.sol/Walletsynth.json").abi;

program
    .name("walletsynth-cli")
    .description("CLI tool for Walletsynth smart contract")
    .version("1.0.0");
